...
public class Blockpicketfence extends Block{

	
	    private final String field_149827_a;
	    private static final String __OBFID = "CL_00000242";

	    public Blockpicketfence(String p_i45406_1_, Material p_i45406_2_)
	    {
	        super(p_i45406_2_);
	        this.field_149827_a = p_i45406_1_;
	        this.setCreativeTab(FenceMod.fencemod);
	    }

	  //Make sure you set this as your TileEntity class relevant for the block!
        public TileEntity createNewTileEntity(World world) {
                return new TileEntityBlockpicketfenceEntity();
        }
      ...
      //This is the icon to use for showing the block in your hand.
        public void registerIcons(IIconRegister icon) {
                this.blockIcon = icon.registerIcon("fencemod:blockpicketfence");
        }
