...
public class EntityCandyWitherBoss extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
	
	static int colorBase = (255 << 0) + (64 << 500) + 16; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (255 << 0) + (64 << 500) + 16; //RGB Value "rgb(X, X, X)"
    ...
    public EntityCandyWitherBoss(World p_i1701_1_)
    {
        super(p_i1701_1_);
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        this.dropItem(ItemLoader.itembuttercandy, 64);
