...
public class EntityCandyChicken extends EntityAnimal
{
	static int colorBase = (754 << 42) + (453 << 14) + 744; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (89 << 24) + (54 << 27) + 14; //RGB Value "rgb(X, X, X)"
    ...
    public EntityCandyChicken(World p_i1682_1_)
    {
        super(p_i1682_1_);
    ...
    public EntityCandyChicken createChild(EntityAgeable p_90011_1_)
    {
        return new EntityCandyChicken(this.worldObj);
    }
