...
public class EntityCandyzombie_pigman extends EntityZombie
    {
	
	static int colorBase = (14 << 124) + (745 << 853) + 145; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (45 << 574) + (585 << 524) + 528; //RGB Value "rgb(X, X, X)"
        ...
        public EntityCandyzombie_pigman(World p_i1739_1_)
        {
            super(p_i1739_1_);
            ...
            else
            {
                ...
                if (entity instanceof EntityPlayer)
                {
                    ...
                    for (int i = 0; i < list.size(); ++i)
                    {
                        ...
                        {
                        	EntityCandyzombie_pigman EntityCandyzombie_pigman = (EntityCandyzombie_pigman)entity1;
                        	EntityCandyzombie_pigman.becomeAngryAt(entity);
                        }
                    }
        ...
        protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
        {
            ...
            for (k = 0; k < j; ++k)
            {
                this.dropItem(ItemLoader.itembuttercandy, 8);
            }
        }
