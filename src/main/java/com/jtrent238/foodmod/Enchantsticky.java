...
public class Enchantsticky extends Enchantment
{
    ...
    public final int stickyType;
    private static final String __OBFID = "CL_00000102";

    public Enchantsticky(int p_i1923_1_, int p_i1923_2_, int p_i1923_3_)
    {
        super(p_i1923_1_, p_i1923_2_, EnumEnchantmentType.weapon);
        this.stickyType = p_i1923_3_;
    }
    ...
    {
        return baseEnchantability[this.stickyType] + (p_77321_1_ - 1) * levelEnchantability[this.stickyType];
    }
    ...
    {
        return this.getMinEnchantability(p_77317_1_) + thresholdEnchantability[this.stickyType];
    }
    ...
    {
        return this.stickyType == 0 ? (float)p_152376_1_ * 1.25F : (this.stickyType == 1 && p_152376_2_ == EnumCreatureAttribute.UNDEAD ? (float)p_152376_1_ * 2.5F : (this.stickyType == 2 && p_152376_2_ == EnumCreatureAttribute.ARTHROPOD ? (float)p_152376_1_ * 2.5F : 0.0F));
    }
    ...
    {
        return "enchantment.sticky." + protectionName[this.stickyType];
    }
    ...
    public void func_151368_a(EntityLivingBase p_151368_1_, Entity p_151368_2_, int p_151368_3_)
    {
        if (p_151368_2_ instanceof EntityLivingBase)
        {
            ...
            if (this.stickyType == 2 && entitylivingbase1.getCreatureAttribute() == EnumCreatureAttribute.ARTHROPOD)
            {
	...
	public  CreativeTabs setCreativeTab() {
