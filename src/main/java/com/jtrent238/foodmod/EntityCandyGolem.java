...
public class EntityCandyGolem extends EntityIronGolem{

    static int colorBase = (852 << 2) + (173 << 9) + 5; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (8 << 7) + (51 << 9) + 9; //RGB Value "rgb(X, X, X)"
    
    
	public EntityCandyGolem(World p_i1694_1_) {
		super(p_i1694_1_);
