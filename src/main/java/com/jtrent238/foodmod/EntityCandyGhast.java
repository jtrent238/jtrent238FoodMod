...
public class EntityCandyGhast extends EntityFlying implements IMob
{
	static int colorBase = (745) + (754) + 555; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (41) + (541) + 52; //RGB Value "rgb(X, X, X)"
    ...
    public EntityCandyGhast(World p_i1735_1_)
    {
        super(p_i1735_1_);
