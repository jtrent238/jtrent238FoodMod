...
public class EntityCandyCow extends EntityAnimal
{
	static int colorBase = (124 << 574) + (574 << 574) + 521; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (4457 << 75) + (457 << 574) + 568; //RGB Value "rgb(X, X, X)"
   
    private static final String __OBFID = "CL_00001640";

    public EntityCandyCow(World p_i1683_1_)
    {
        super(p_i1683_1_);
    ...
    public EntityCandyCow createChild(EntityAgeable p_90011_1_)
    {
        return new EntityCandyCow(this.worldObj);
    }
}