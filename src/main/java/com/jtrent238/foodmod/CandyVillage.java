...
public class CandyVillage
{
    private World worldObj;
    /** list of CandyVillageDoorInfo objects */
    private final List CandyVillageDoorInfoList = new ArrayList();
    /**
    ...
    public CandyVillage(World p_i1675_1_)
    {
    ...
    public void tick(int p_75560_1_)
    {
        ...
        if (this.numIronGolems < j && this.CandyVillageDoorInfoList.size() > 20 && this.worldObj.rand.nextInt(7000) == 0)
        {
            ...
            if (vec3 != null)
            {
            	EntityCandyGolem entitycandygolem = new EntityCandyGolem(this.worldObj);
                entitycandygolem.setPosition(vec3.xCoord, vec3.yCoord, vec3.zCoord);
                this.worldObj.spawnEntityInWorld(entitycandygolem);
                ++this.numIronGolems;
            }
        }
    }
    ...
    {
        return this.CandyVillageDoorInfoList.size();
    }
     ...
     */
    public List getCandyVillageDoorInfoList()
    {
        return this.CandyVillageDoorInfoList;
    }

    public CandyVillageDoorInfo findNearestDoor(int p_75564_1_, int p_75564_2_, int p_75564_3_)
    {
        CandyVillageDoorInfo CandyVillageDoorInfo = null;
        int l = Integer.MAX_VALUE;
        Iterator iterator = this.CandyVillageDoorInfoList.iterator();

        while (iterator.hasNext())
        {
            CandyVillageDoorInfo CandyVillageDoorInfo1 = (CandyVillageDoorInfo)iterator.next();
            int i1 = CandyVillageDoorInfo1.getDistanceSquared(p_75564_1_, p_75564_2_, p_75564_3_);

            if (i1 < l)
            {
                CandyVillageDoorInfo = CandyVillageDoorInfo1;
                l = i1;
            }
        }

        return CandyVillageDoorInfo;
    }
     ...
     * of restriction.
     */
    public CandyVillageDoorInfo findNearestDoorUnrestricted(int p_75569_1_, int p_75569_2_, int p_75569_3_)
    {
        CandyVillageDoorInfo CandyVillageDoorInfo = null;
        int l = Integer.MAX_VALUE;
        Iterator iterator = this.CandyVillageDoorInfoList.iterator();
        ...
        {
            CandyVillageDoorInfo CandyVillageDoorInfo1 = (CandyVillageDoorInfo)iterator.next();
            int i1 = CandyVillageDoorInfo1.getDistanceSquared(p_75569_1_, p_75569_2_, p_75569_3_);
            ...
            {
                i1 = CandyVillageDoorInfo1.getDoorOpeningRestrictionCounter();
            }
    ...
    public CandyVillageDoorInfo getVillageDoorAt(int p_75578_1_, int p_75578_2_, int p_75578_3_)
    {
        ...
        {
            Iterator iterator = this.CandyVillageDoorInfoList.iterator();
            CandyVillageDoorInfo CandyVillageDoorInfo;
            ...
            do
            {
                ...
                CandyVillageDoorInfo = (CandyVillageDoorInfo)iterator.next();
            }
            while (CandyVillageDoorInfo.posX != p_75578_1_ || CandyVillageDoorInfo.posZ != p_75578_3_ || Math.abs(CandyVillageDoorInfo.posY - p_75578_2_) > 1);

            return CandyVillageDoorInfo;
        }
    }

    public void addCandyVillageDoorInfo(CandyVillageDoorInfo p_75576_1_)
    {
        this.CandyVillageDoorInfoList.add(p_75576_1_);
    ...
    {
        return this.CandyVillageDoorInfoList.isEmpty();
    }

    public void addOrRenewAgressor(EntityLivingBase p_75575_1_)
    {
        Iterator iterator = this.villageAgressors.iterator();
        CandyVillage.VillageAgressor villageagressor;

        do
        {
            if (!iterator.hasNext())
            {
                this.villageAgressors.add(new CandyVillage.VillageAgressor(p_75575_1_, this.tickCounter));
                return;
            }

            villageagressor = (CandyVillage.VillageAgressor)iterator.next();
        }
    ...
    public EntityLivingBase findNearestVillageAggressor(EntityLivingBase p_75571_1_)
    {
        ...
        CandyVillage.VillageAgressor villageagressor = null;

        for (int i = 0; i < this.villageAgressors.size(); ++i)
        {
            CandyVillage.VillageAgressor villageagressor1 = (CandyVillage.VillageAgressor)this.villageAgressors.get(i);
    ...
    private void removeDeadAndOldAgressors()
    {
        ...
        while (iterator.hasNext())
        {
            CandyVillage.VillageAgressor villageagressor = (CandyVillage.VillageAgressor)iterator.next();
    ...
    private void removeDeadAndOutOfRangeDoors()
    {
        ...
        while (iterator.hasNext())
        {
            CandyVillageDoorInfo CandyVillageDoorInfo = (CandyVillageDoorInfo)iterator.next();

            if (flag1)
            {
                CandyVillageDoorInfo.resetDoorOpeningRestrictionCounter();
            }

            if (!this.isBlockDoor(CandyVillageDoorInfo.posX, CandyVillageDoorInfo.posY, CandyVillageDoorInfo.posZ) || Math.abs(this.tickCounter - CandyVillageDoorInfo.lastActivityTimestamp) > 1200)
            {
                this.centerHelper.posX -= CandyVillageDoorInfo.posX;
                this.centerHelper.posY -= CandyVillageDoorInfo.posY;
                this.centerHelper.posZ -= CandyVillageDoorInfo.posZ;
                flag = true;
                CandyVillageDoorInfo.isDetachedFromVillageFlag = true;
                iterator.remove();
            }
        }
    ...
    {
        return this.worldObj.getBlock(p_75574_1_, p_75574_2_, p_75574_3_) == Blocks.wooden_door;//BlockLoader.BlockCandyDoor
    }

    private void updateVillageRadiusAndCenter()
    {
        int i = this.CandyVillageDoorInfoList.size();
        ...
        else
        {
            ...
            for (Iterator iterator = this.CandyVillageDoorInfoList.iterator(); iterator.hasNext(); j = Math.max(CandyVillageDoorInfo.getDistanceSquared(this.center.posX, this.center.posY, this.center.posZ), j))
            {
                CandyVillageDoorInfo = (CandyVillageDoorInfo)iterator.next();
            }
    ...
    public void readVillageDataFromNBT(NBTTagCompound p_82690_1_)
    {
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i)
        {
            ...
            CandyVillageDoorInfo CandyVillageDoorInfo = new CandyVillageDoorInfo(nbttagcompound1.getInteger("X"), nbttagcompound1.getInteger("Y"), nbttagcompound1.getInteger("Z"), nbttagcompound1.getInteger("IDX"), nbttagcompound1.getInteger("IDZ"), nbttagcompound1.getInteger("TS"));
            this.CandyVillageDoorInfoList.add(CandyVillageDoorInfo);
        }
    ...
    public void writeVillageDataToNBT(NBTTagCompound p_82689_1_)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            nbttagcompound1.setInteger("X", CandyVillageDoorInfo.posX);
            nbttagcompound1.setInteger("Y", CandyVillageDoorInfo.posY);
            nbttagcompound1.setInteger("Z", CandyVillageDoorInfo.posZ);
            nbttagcompound1.setInteger("IDX", CandyVillageDoorInfo.insideDirectionX);
            nbttagcompound1.setInteger("IDZ", CandyVillageDoorInfo.insideDirectionZ);
            nbttagcompound1.setInteger("TS", CandyVillageDoorInfo.lastActivityTimestamp);
