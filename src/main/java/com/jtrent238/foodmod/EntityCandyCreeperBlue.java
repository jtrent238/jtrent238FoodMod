...
public class EntityCandyCreeperBlue extends EntityMob
{
	static int colorBase = (14 << 535) + (256 << 345) + 254; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (24 << 25) + (356 << 245) + 456; //RGB Value "rgb(X, X, X)"
    ...
    public EntityCandyCreeperBlue(World p_i1733_1_)
    {
        super(p_i1733_1_);
