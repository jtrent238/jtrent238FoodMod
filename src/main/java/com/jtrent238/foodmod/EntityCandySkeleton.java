...
public class EntityCandySkeleton extends EntityMob implements IRangedAttackMob
{
	static int colorBase = (14 << 145) + (548 << 542) + 645; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (45 << 548) + (478 << 546) + 245; //RGB Value "rgb(X, X, X)"
   
    private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 20, 60, 15.0F);
    private EntityAIAttackOnCollide aiAttackOnCollide = new EntityAIAttackOnCollide(this, EntityPlayer.class, 1.2D, false);
    private static final String __OBFID = "CL_00001697";

    public EntityCandySkeleton(World p_i1741_1_)
    {
        super(p_i1741_1_);
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        if (this.getSkeletonType() == 1)
        {
            ...
            for (k = 0; k < j; ++k)
            {
                ...
                this.dropItem(ItemLoader.itembuttercandy, 4);
            }
        }
        else
        {
