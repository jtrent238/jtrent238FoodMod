...
public class Blockcandycanereed extends Block implements IPlantable
{
    private static final String __OBFID = "CL_00000300";

    protected Blockcandycanereed()
    {
        super(Material.plants);
        float f = 0.375F;
        this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, 1.0F, 0.5F + f);
        this.setTickRandomly(true);
        this.setBlockName("blockcandycanereeds");
        this.setBlockTextureName("foodmod:blockcandycanereeds");    
        }
    ...
    {
        if (p_149674_1_.getBlock(p_149674_2_, p_149674_3_ - 1, p_149674_4_) == BlockLoader.blockcandycanereed || this.func_150170_e(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_))
        {
    ...
    {
        return ItemLoader.itemcandycanereed;
    }
