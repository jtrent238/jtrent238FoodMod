...
public class BiomeDecoratorHelper {
    ...
    protected static void decorateBiome(BiomeGenBase biome) {
        ...
        if(biome == ModBiomes.candyland){
            BiomeDecoratorMod.howMenyTrees = BiomeCandyLand.treesPerChunk;
                ...
                if(i == BiomeDecoratorMod.randomGenerator.nextInt(8)){
                    ...
                    if(block != Blocks.air || block != Blocks.water){
                        if(blockA != Blocks.air || blockA != Blocks.water){
                            BiomeDecoratorMod.candyTree.generate(BiomeDecoratorMod.currentWorld, BiomeDecoratorMod.randomGenerator, chunkX, y, chunkZ);
                        }
                    }
                }
    ...
    private static void initOres() {
        ...
        glowStone = new WorldGenMinable(Blocks.glowstone, 30, BlockLoader.blockcandystone);
    }
