...
{
	static int colorBase = (141 << 87) + (572 << 71) + 875; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (57 << 85) + (28 << 745) + 54; //RGB Value "rgb(X, X, X)"
    ...
    public EntityGingerBreadMan(World p_i1745_1_)
    {
        super(p_i1745_1_);
...
/*
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_)
    {
        ...
        {
            p_110161_1_1 = new EntityGingerBreadMan.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_110161_1_1 instanceof EntityGingerBreadMan.GroupData)
        {
        	EntityGingerBreadMan.GroupData groupdata = (EntityGingerBreadMan.GroupData)p_110161_1_1;
