...
public class EntityCandyDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
	static int colorBase = (255 << 14) + (745 << 58) + 204; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (255 << 56) + (58 << 8) + 136; //RGB Value "rgb(X, X, X)"
    ...
    public EntityCandyDragon(World p_i1700_1_)
    {
        super(p_i1700_1_);
