...
public class EntityCandyBat extends EntityAmbientCreature
{
	
	static int colorBase = (232 << 55) + (5472 << 751) + 85; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (587 << 52) + (288 << 45) + 574; //RGB Value "rgb(X, X, X)"
   
    /** Coordinates of where the bat spawned. */
    private ChunkCoordinates spawnPosition;
    private static final String __OBFID = "CL_00001637";

    public EntityCandyBat(World p_i1680_1_)
    {
        super(p_i1680_1_);
