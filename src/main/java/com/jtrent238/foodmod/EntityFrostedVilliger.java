...
public class EntityFrostedVilliger extends EntityAgeable implements IMerchant, INpc
{
	static int colorBase = (255 << 15) + (235 << 5) + 245; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (255 << 46) + (54 << 2) + 874; //RGB Value "rgb(X, X, X)"
    ...
    public EntityFrostedVilliger(World p_i1747_1_)
    {
        this(p_i1747_1_, 0);
    }

    public EntityFrostedVilliger(World p_i1748_1_, int p_i1748_2_)
    {
        super(p_i1748_1_);
    ...
    {
    	this.entityDropItem(new ItemStack(ItemLoader.itembuttercandy), 5.0F);
        this.entityDropItem(new ItemStack(Items.sugar), 5.0F);
    }
    ...
    public EntityFrostedVilliger createChild(EntityAgeable p_90011_1_)
    {
    	return new EntityFrostedVilliger(this.worldObj);
    }
