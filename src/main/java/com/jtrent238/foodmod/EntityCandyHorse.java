...
public class EntityCandyHorse extends EntityAnimal implements IInvBasic
{
	static int colorBase = (14 << 142) + (475 << 141) + 124; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (45 << 265) + (142 << 201) + 245; //RGB Value "rgb(X, X, X)"
    ...
    private static final String[] horseArmorTextures = new String[] {null, "textures/CandyHorse/armor/horse_armor_iron.png", "textures/CandyHorse/armor/horse_armor_gold.png", "textures/CandyHorse/armor/horse_armor_diamond.png"};
    private static final String[] field_110273_bx = new String[] {"", "meo", "goo", "dio"};
    private static final int[] armorValues = new int[] {0, 5, 7, 11};
    private static final String[] horseTextures = new String[] {"textures/CandyHorse/horse_white.png", "textures/CandyHorse/horse_creamy.png", "textures/CandyHorse/horse_chestnut.png", "textures/CandyHorse/horse_brown.png", "textures/CandyHorse/horse_black.png", "textures/CandyHorse/horse_gray.png", "textures/CandyHorse/horse_darkbrown.png"};
    private static final String[] field_110269_bA = new String[] {"hwh", "hcr", "hch", "hbr", "hbl", "hgr", "hdb"};
    private static final String[] horseMarkingTextures = new String[] {null, "textures/CandyHorse/horse_markings_white.png", "textures/CandyHorse/horse_markings_whitefield.png", "textures/CandyHorse/horse_markings_whitedots.png", "textures/CandyHorse/horse_markings_blackdots.png"};
    ...
    private int ModelHorse;

    public EntityCandyHorse(World p_i1685_1_)
    {
        super(p_i1685_1_);
    ...
    private void ModelHorse() {
    	this.RenderLiving(new ModelHorse(), 0);
		
	}

	private void RenderLiving(net.minecraft.client.model.ModelHorse modelHorse2, int i) {
    ...
    public void openGUI(EntityPlayer p_110199_1_)
    {
        ...
        {
            this.horseChest.func_110133_a(this.getCommandSenderName());
            this.displayGUICandyHorse(this, this.horseChest);
        }
    }
    	
    private void displayGUICandyHorse(EntityCandyHorse entityCandyHorse, AnimalChest horseChest2) {
    ...
    public boolean canMateWith(EntityAnimal p_70878_1_)
    {
        ...
        {
        	EntityCandyHorse entityhorse = (EntityCandyHorse)p_70878_1_;
    ...
    {
    	EntityCandyHorse entityCandyHorse = (EntityCandyHorse)p_90011_1_;
        EntityCandyHorse entityCandyHorse1 = new EntityCandyHorse(this.worldObj);
        int i = this.getHorseType();
        int j = entityCandyHorse.getHorseType();
        int k = 0;
        ...
        if (k == 0)
        {
            ...
            {
                l = entityCandyHorse.getHorseVariant() & 255;
            }
            else
            {
            ...
            {
                l |= entityCandyHorse.getHorseVariant() & 65280;
            }
            else
            {
            ...
            entityCandyHorse1.setHorseVariant(l);
        }

        entityCandyHorse1.setHorseType(k);
        ...
        entityCandyHorse1.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(d1 / 3.0D);
        ...
        entityCandyHorse1.getEntityAttribute(horseJumpStrength).setBaseValue(d2 / 3.0D);
        ...
        entityCandyHorse1.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(d0 / 3.0D);
        return entityCandyHorse1;
    }
