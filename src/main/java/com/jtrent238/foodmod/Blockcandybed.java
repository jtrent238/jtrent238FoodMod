...
public class Blockcandybed extends BlockDirectional
{
    ...
    public Blockcandybed()
    {
        ...
        this.func_149978_e();
        this.setBlockName("BlockCandyBed");
    }
    ...
    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
         ...
         */
        return isBlockHeadOfBed(p_149650_1_) ? Item.getItemById(0) : ItemLoader.itemcandybed;
    }
    ...
    {
        return ItemLoader.itemcandybed;
    }
