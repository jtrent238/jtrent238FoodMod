...
public class BlockOven2 extends BlockContainer
{
    ...
    protected BlockOven2(Material anvil)
    {
        super(Material.anvil);
        this.material = anvil;
        this.getItemStackDisplayName(this);

    }


	private void getItemStackDisplayName(BlockOven2 blockOven) {
    ...
    {
        return Item.getItemFromBlock(BlockLoader.BlockOven);
    }
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("foodmod:BlockOvenSide");
        this.field_149936_O = p_149651_1_.registerIcon(this.field_149932_b ? "foodmod:BlockOvenOn" : "foodmod:BlockOvenOff");
        this.field_149935_N = p_149651_1_.registerIcon("foodmod:BlockOvenTop");
    }
   ...
   public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
   {
    ...
    public static void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, BlockLoader.BlockOvenActive);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, BlockLoader.BlockOven);
        }
    ...
    {
        if ((Boolean) this.field_149932_b)
        {
