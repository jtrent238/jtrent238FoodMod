...
public class Blockfrozenpumpkin extends BlockDirectional
{
	...
	private float p_149711_1_;
    private static final String __OBFID = "CL_00000291";

    protected Blockfrozenpumpkin(boolean p_i45419_1_)
    {
        super(Material.gourd);
        this.setTickRandomly(true);
        this.field_149985_a = p_i45419_1_;
        this.setBlockName("blockfrozenpumpkin");
    ...
    {
        this.field_149986_M = p_149651_1_.registerIcon(this.getTextureName() + "_face");
