...
public class cakechest extends BlockChest {

	protected cakechest(int material, int wood) {
		super(wood);
	}
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntitycakechest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        TileEntitycakechest tileentitychest = (TileEntitycakechest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);
    ...
    {
    	TileEntitycakechest tileentitychest = (TileEntitycakechest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
    ...
    {
        Object object = (TileEntitycakechest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
        ...
        else
        {
            ...
            {
                object = new InventoryLargeChest("Large Tut Chest", (TileEntitycakechest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
            {
                object = new InventoryLargeChest("Large Tut Chest", (IInventory)object, (TileEntitycakechest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
            {
                object = new InventoryLargeChest("Large Tut Chest", (TileEntitycakechest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
            {
                object = new InventoryLargeChest("Large Tut Chest", (IInventory)object, (TileEntitycakechest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
            }
    ...
    {
        Iterator iterator = p_149953_0_.getEntitiesWithinAABB(EntityOcelot.class, getAABB((double)p_149953_1_, (double)(p_149953_2_ + 1), (double)p_149953_3_, (double)(p_149953_1_ + 1), (double)(p_149953_2_ + 2), (double)(p_149953_3_ + 1))).iterator();
    ...
    private static AxisAlignedBB getAABB(double p_149953_1_, double d, double p_149953_3_, double e, double f,
			double g) {
		return null;
	}
    ...
    {
        TileEntitycakechest tileentitychest = new TileEntitycakechest();
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("FoodMod:TutChest");
    }
