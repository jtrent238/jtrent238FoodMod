...
public class EntityCandySpider extends EntityMob
{
	static int colorBase = (24 << 75) + (474 << 414) + 245; //RGB Value "rgb(X, X, X)"
    static int colorSpots  = (142 << 457) + (14 << 245) + 425; //RGB Value "rgb(X, X, X)"
   
    private static final String __OBFID = "CL_00001699";

    public EntityCandySpider(World p_i1743_1_)
    {
        super(p_i1743_1_);
