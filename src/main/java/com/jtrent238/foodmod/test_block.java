...
GameRegistry.registerBlock(block, "Testblock");
}
...
block = (BlockTestblock)(new BlockTestblock().setHardness(2.0F)
.setResistance(10.0F)
.setLightLevel(0.0F)
...
Block.blockRegistry.addObject(178, "Testblock", block);
...
if(true){
if(entity instanceof EntityPlayer)((EntityPlayer)entity).openGui(instance, test_gui.GUIID, world, i, j, k);
}
