...
public class TeleporterCandyLand extends Teleporter
{
	...
	public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_)
    {
        ...
        {
            TeleporterCandyLand.PortalPosition portalposition = (TeleporterCandyLand.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
    ...
    public void removeStalePortalLocations(long p_85189_1_)
    {
        if (p_85189_1_ % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                TeleporterCandyLand.PortalPosition portalposition = (TeleporterCandyLand.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
