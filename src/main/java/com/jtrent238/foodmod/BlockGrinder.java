...
public class BlockGrinder extends BlockContainer
{
    ...
    {
        int k = p_149691_2_ & 7;
        return p_149691_1_ == k ? (k != 1 && k != 0 ? this.blockIcon : this.field_149946_O) : (k != 1 && k != 0 ? (p_149691_1_ != 1 && p_149691_1_ != 0 ? this.blockIcon : this.field_149944_M) : this.field_149944_M);
    }
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        {
        	TileEntityGrinder tileentitygrinder = (TileEntityGrinder)p_149727_1_.getTileEntity(p_149727_2_, p_149727_3_, p_149727_4_);

            if (tileentitygrinder != null)
            {
                p_149727_5_.func_146100_a(tileentitygrinder);
            }
...
/*
    protected void func_149941_e(World p_149941_1_, int p_149941_2_, int p_149941_3_, int p_149941_4_)
    {
        ...
        TileEntityGrinder tileentitygrinder = (TileEntityGrinder)blocksourceimpl.getBlockTileEntity();

        if (tileentitygrinder != null)
        {
            int l = tileentitygrinder.func_146017_i();

            if (l < 0)
            {
                p_149941_1_.playAuxSFX(l, l, l, l, l);
            }
            else
            {
                ...
                if (ibehaviordispenseitem != IBehaviorDispenseItem.itemDispenseBehaviorProvider)
                {
                    ...
                    tileentitygrinder.setInventorySlotContents(l, itemstack1.stackSize == 0 ? null : itemstack1);
                }
            }
        }
    }
...
*/
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityGrinder)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_146018_a(p_149689_6_.getDisplayName());
        }
    }

    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        TileEntityGrinder tileentitygrinder = (TileEntityGrinder)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
