...
public class EntityCandyCreeper extends EntityMob
{
	 	static int colorBase = (852 << 12) + (453 << 4) + 5; //RGB Value "rgb(X, X, X)"
	    static int colorSpots  = (8 << 45) + (54 << 45) + 53; //RGB Value "rgb(X, X, X)"
    ...
    public EntityCandyCreeper(World p_i1733_1_)
    {
        super(p_i1733_1_);
    ...
    public void onDeath(DamageSource p_70645_1_)
    {
        ...
        if (p_70645_1_.getEntity() instanceof EntityCreeper)
        {
        	...
        	entitycreeper.setCurrentItemOrArmor(0, new ItemStack(Items.diamond_sword));
        	entitycreeper.setCurrentItemOrArmor(1, new ItemStack(Items.diamond_helmet));
        	entitycreeper.setCurrentItemOrArmor(2, new ItemStack(Items.diamond_chestplate));
        	entitycreeper.setCurrentItemOrArmor(3, new ItemStack(Items.diamond_leggings));
        	entitycreeper.setCurrentItemOrArmor(4, new ItemStack(Items.diamond_boots));
        	entitycreeper.setLocationAndAngles(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch);
