...
public class plantSeeds extends Item implements IPlantable
{ 
    ...
    private String name = "plantSeeds";
    
    public plantSeeds(Block par2, Block par3)
    {
  		setUnlocalizedName("plantSeeds");
  		setTextureName("foodmod:plantSeeds");
