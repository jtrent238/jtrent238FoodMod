...
public class WorldGenCandyTrees extends WorldGenCandyAbstractTree
{
    ...
    public WorldGenCandyTrees(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 6, leaves, wood, false);
    }

    public WorldGenCandyTrees(boolean p_i2028_1_, int minTreeHeight, Block metaWood, Block metaLeaves, boolean growVines)
    {
        super(p_i2028_1_);
        this.minTreeHeight = minTreeHeight;
        WorldGenCandyTrees.wood = metaWood;
        WorldGenCandyTrees.leaves = metaLeaves;
