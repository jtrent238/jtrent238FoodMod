...
public class WeaponMod
{
  ...
  public void preInit(FMLPreInitializationEvent event)
  {
    ...
    //Creeper In A Jar
    blockcreeperinajar = new blockcreeperInaJar(Material.ground).setBlockName("blockcreeperinajar").setBlockTextureName("weaponmod:blockcreeperinajar").setCreativeTab(tabWeaponMod);
    GameRegistry.registerBlock(blockcreeperinajar, blockcreeperinajar.getUnlocalizedName().substring(5));
